...
This module exports two functions I<strcut_encode> and I<struct_decode>.
...
Simple types are just I<CORE::pack> types.
...
In I<pack> => 'A3Z256A3Z256' or '(A3Z256)2'
...
It's complicated in I<pack> to write some strcutures if number of elements is not present in front of array. In I<struct> can be placed anywhere before array definition.
