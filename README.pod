...
This module exports two functions C<strcut_encode> and C<struct_decode>.
...
It's complicated in C<pack> to write some strcutures if number of elements is not present in front of array. In C<struct> can be placed anywhere before array definition.
